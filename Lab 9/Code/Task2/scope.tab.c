...
#ifndef YY_YY_SCOPE_TAB_H_INCLUDED
# define YY_YY_SCOPE_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_YY_SCOPE_TAB_H_INCLUDED  */
...
{
  "$end", "error", "$undefined", "keyword_int", "T_int", "identifier",
  "cout", "'='", "';'", "'<'", "'{'", "'}'", "$accept", "S", "E", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    61,    59,    60,
     123,   125
};
# endif
...
{
      -3,    -4,     4,    -5,    -3,    -3,    12,    -6,    -2,     9,
       6,     3,    -6,    -6,    13,    -6,     8,    14,    -6,    10,
      -6,    15,    -6,    -6
};
...
{
       1,     8,     2,     3,    10,    14,    15,     4,     5,    11,
      12,     9,    13,    16,    18,    17,    20,    19,    22,    21,
       0,     0,     0,    23
};

static const yytype_int8 yycheck[] =
{
       3,     5,     5,     6,     9,     7,     8,    10,    11,     4,
       5,     7,     0,     4,    11,     9,     8,     4,     8,     5,
      -1,    -1,    -1,     8
};
...
{
       0,     3,     5,     6,    10,    11,    13,    14,     5,     7,
       9,    14,    14,     0,     7,     8,     4,     9,    11,     4,
       8,     5,     8,     8
};
...
#line 45 "scope.y"
      {  }
#line 1338 "scope.tab.c"
    break;

  case 3:
#line 47 "scope.y"
                                          {newIdentifier(yylval.name, yylval.val);}
#line 1344 "scope.tab.c"
    break;

  case 4:
#line 48 "scope.y"
                            {newIdentifier(yylval.name, NULL);}
#line 1350 "scope.tab.c"
    break;

  case 5:
#line 49 "scope.y"
                            {Identifier(yylval.name, yylval.val);}
#line 1356 "scope.tab.c"
    break;

  case 6:
#line 50 "scope.y"
                            {std::cout<<">> "<<yylval.name<<" = "<<returnIdentifier(yylval.name)<<std::endl;}
#line 1362 "scope.tab.c"
    break;

  case 7:
#line 51 "scope.y"
            { Push();}
#line 1368 "scope.tab.c"
    break;

  case 8:
#line 52 "scope.y"
        {Pop();}
#line 1374 "scope.tab.c"
    break;


#line 1378 "scope.tab.c"
